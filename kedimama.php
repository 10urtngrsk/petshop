...
<html>
<head>
	<title>Pet Shop - Kedi Mamalari</title>
...
<input type='text' name='T2' size='12'>
			...
			<div id="body">
			  <h2 align="center">Pet Shop - Kedi Mamaları</h2>
				<p align="center">
				<iframe name="I1" width="720" height="360" src="balikdetay.php" border="0" frameborder="0">Taray�c�n�z sat�r i�i �er�eveleri desteklemiyor veya �u anda sat�r i�i �er�eveleri g�stermek i�in yap�land�r�lmam��.</iframe></p>


</div>
<center><table border="0" width="80%">
<?php
$ara=mysql_query("select * from urun where urunkategori='kedi' AND urungrup='mama'");
