...
<html>
<head>
	<title>Pet Shop - Kedi Barınakları</title>
...
<input type='text' name='T2' size='12'>
			...
			<div id="body">
			  <h2 align="center">Pet Shop - Kedi Barınakları</h2>
				<p align="center">
				<iframe name="I1" width="757" height="392" src="balikdetay.php" border="0" frameborder="0">Taray�c�n�z sat�r i�i �er�eveleri desteklemiyor veya �u anda sat�r i�i �er�eveleri g�stermek i�in yap�land�r�lmam��.</iframe></p>


</div>
<center><table border="0" width="80%">
<?php
$ara=mysql_query("select * from urun where urunkategori='kedi' AND urungrup='ev'");
...
<a href='balikdetay.php?urun=".$id."' target='I1'><img src=get.php?id=$id width='100' height='100'><br>$urunadi</a>
 <br>Fiyat�: $urunfiyat TL<br>Stok Adedi: $stokadet <br>--------------------
</td>
</tr>
";
