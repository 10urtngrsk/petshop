...
<html>
<head>
	<title>Pet Shop - Balık Akvaryumları</title>
...
<input type='text' name='T2' size='12'>
			...
			<div id="body">
			  <h2 align="center">Pet Shop - Balık Akvaryumları</h2>
				<p align="center">
				<iframe name="I1" width="792" height="364" src="balikdetay.php" border="0" frameborder="0">Tarayıcınız satır içi çerçeveleri desteklemiyor veya şu anda satır içi çerçeveleri göstermek için yapılandırılmamış.</iframe></p>


</div>
<center><table border="0" width="80%">
<?php
$ara=mysql_query("select * from urun where urunkategori='balik' AND urungrup='ev'");
